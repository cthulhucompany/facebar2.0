    ...
    <div class="row-fluid">
      ...
      <div class="span1">
        ...
        <aside class="side-left">
          <ul class="sidebar">
            <li>
              <a href="index.html" title="Noticias">
                        ...
                        <form class="form-horizontal" id="form-validate">
                          <fieldset>
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="text" class="grd-white" data-validate="{required: true, email:true, messages:{required:'Por favor ingresa un correo', email:'Direccion de correo '}}" name="email" id="email" />
                              </div>
                            </div>
                            ...
                            <div class="control-group">
                              ...
                              <div class="controls">
                                <input type="password" class="grd-white" data-validate="{required: true, messages:{required:'Por favor ingresa la contrasena'}}" name="password" id="password" />
                              </div>
                            </div>
                            <div class="control-group">
                              <label class="control-label" for="cpassword">Confirmar Contrasena</label>
                              <div class="controls">
                                <input type="password" class="grd-white" data-validate="{required: true, equalTo: '#password', messages:{required:'Por favor ingresa la contrasena', equalTo: 'Las contrasenias no coinciden'}}" name="cpassword" id="cpassword" />
                              </div>
                            </div>
